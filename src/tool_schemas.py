"""Tool schemas advertised to the LLM in OpenAI function-calling format.

Kept separate from tools.py so the runtime signatures and the LLM-visible
surface don't drift together.
"""
